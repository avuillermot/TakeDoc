...
namespace UnitTestTakeDocService.Folder
{
    ...
    public class FolderServiceTest : BaseServiceTest
    {
        ...
        {
            string json = "entityId: \"{0}\", userCreateId: \"{1}\", ownerId: \"{2}\", title: \"{3}\", folderTypId: \"{4}\", start: \"{5}\", end: \"{6}\"";
        ...
        {
            string json = "folderId: \"{0}\",entityId: \"{1}\", userUpdateId: \"{2}\", title: \"{3}\", label: \"{4}\", folderTypId: \"{5}\", start: \"{6}\", end: \"{7}\", ownerId: \"{8}\"";
