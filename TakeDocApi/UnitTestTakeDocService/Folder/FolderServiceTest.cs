...
namespace UnitTestTakeDocService.Folder
{
    ...
    public class FolderServiceTest : BaseServiceTest
    {
        ...
        public void ToUpdate()
        {
            ...
            string value = string.Concat("{", string.Format(json, folder.FolderId.ToString(), folder.EntityId.ToString(), base.userId.ToString(), base.userId.ToString(), "mon rdv2", "FAC8EFBC-001D-4C4B-85EF-8ACDDE1EA724", "2016-09-08T20:07:39.560Z", "2016-09-08T21:07:39.560Z"), "}");
