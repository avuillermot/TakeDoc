...
{
    [TestClass]
    public class WorkflowManagerBackofficeTest : UnitTestTakeDocService.BaseServiceTest
    {
        ...
        public void CreateDocument()
        {
            ...
            TakeDocModel.TypeDocument typeDocument = daoTypeDocument.GetBy(x => x.TypeDocumentReference == "TEST-INTEGRATION-MANAGERBO-VALIDATION").First();
            MyDocument = servDocument.Create(userId, entityId, typeDocument.TypeDocumentId, "Test intégration manager-backoffice validation");
        ...
        public void SetMetaData()
        {
            ...
            //servDocument.Update(userId, entityId, MyDocument.DocumentCurrentVersionId.Value, string.Empty, true);
