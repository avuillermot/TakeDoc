...
{
    [TestClass]
    public class WorkflowBackofficeTest : UnitTestTakeDocService.BaseServiceTest
    {
        ...
        public void CreateDocument()
        {
            ...
            TakeDocModel.TypeDocument typeDocument = daoTypeDocument.GetBy(x => x.TypeDocumentReference == "TEST-INTEGRATION-BACKOFFICE-VALIDATION").First();
            MyDocument = servDocument.Create(userId, entityId, typeDocument.TypeDocumentId, "Test intégration backoffice validation");
            ...
            Assert.IsTrue(MyDocument.Type_Document.TypeDocumentReference == "TEST-INTEGRATION-BACKOFFICE-VALIDATION");
            Assert.IsTrue(MyDocument.DocumentLabel == "Test intégration backoffice validation");
